 ...
 * @next: Declared for the pointer to next node
 * @string: It is the path name of the environment variable
 */
 ...
 * @errorStatus: error status of the last child process
 * @env: It is the linked list of local env variables
 * @envList: The array of env variables to execve all
 * @path: This is the array that gives the $ PATH locations
 * @fullPath: path string with $ PATH at correct beginning
 * @args: the array of strings with arguments
 * @buffer: the user's input string buffer
 * @lineCounter: counter of lines that users have entered
 * @shellName: shell name (argv [0])
 */
